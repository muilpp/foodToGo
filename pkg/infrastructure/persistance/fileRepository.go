...
func NewFileRepository(bearerFileName string, storesFileName string) *FileRepository {
	return &FileRepository{bearerFileName: bearerFileName, storesFileName: storesFileName}
}
